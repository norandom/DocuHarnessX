...
- [ ] 1. Foundation: package scaffold, environment, shared types, and errors
- [ ] 1.1 Scaffold the installable package and uv manifest (sole package-root owner)
...
- [ ] 1.2 Define shared types, slot-key constants, and explicit error types
...
- [ ] 2. Core: configuration, model resolution, context, and stage stubs
- [ ] 2.1 (P) Implement the configuration surface and precedence
...
- [ ] 2.2 (P) Implement model resolution with config-then-env precedence
...
- [ ] 2.3 (P) Implement the RunContext data-passing seam
...
- [ ] 2.4 (P) Consume the ontology-engine interfaces at the contract level (pinned imports)
...
- [ ] 2.5 (P) Implement the no-op stage stubs and the stage base
...
- [ ] 2.6 (P) Implement run-start ontology loading into the run context
...
- [ ] 2.7 (P) Implement the `dhx init` ontology setup helpers
...
- [ ] 3. Stage registration and bundle composition
- [ ] 3.1 Implement the stage-registration contract and canonical ordering
...
- [ ] 3.2 Implement make_docgen bundle composition
...
- [ ] 4. Integration: the dhx CLI and run orchestration
- [ ] 4.1 Implement the dhx CLI argument parsing, validation, ontology loading, and model binding
...
- [ ] 4.2 Orchestrate the end-to-end run, journaling, reporting, and exit codes
...
- [ ] 4.3 Wire the `dhx init` subcommand to ontology setup
...
- [ ] 5. Validation: end-to-end acceptance and observability
- [ ] 5.1 End-to-end acceptance test on the empty pipeline and `dhx init`
...
- [ ] 5.2 Validation tests for failure paths and stage replaceability
