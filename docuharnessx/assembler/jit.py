"""Copy the InfoVis Toolkit into an assembled site and boot the Hypertree."""
...
JIT_JS_PATH = "javascripts/jit.js"
...
def load_jit_javascript() -> str:
    """Return the vendored JIT 2.0.1 build (MIT, Sencha / Nicolas Garcia Belmonte)."""
    return files("docuharnessx.assembler.vendor").joinpath("jit-yc.js").read_text(
        encoding="utf-8"
    )


def render_conceptual_js() -> str:
    """Return the Hypertree boot script."""
    return _CONCEPTUAL_JS
